            ...
            Column() {
                ExpandableActionButton(
                    ...
                    onFabClick = {
                        if (fabExpanded) {
                            fabExpanded = false
                            navigateToLinkRecordsPage(item.id)
                        } else {
                            fabExpanded = true
                        }
                    },
